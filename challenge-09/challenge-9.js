(function () {
    ...
    */
    ...
    console.log(sum(function (firstNumber, secondNumber) { return firstNumber + secondNumber; }));
    ...
    */
    let subtraction = calculator(30, 20);
    let multiplication = calculator(20, 10);
    let division = calculator(50, 5);
    let mod = calculator(100, 9);
    ...
    */
    ...
    console.log(subtraction(function (firstNumber, secondNumber) { return firstNumber - secondNumber; }));

    console.log('O resultado da multiplicação é:');
    console.log(multiplication(function (firstNumber, secondNumber) { return firstNumber * secondNumber; }));

    console.log('O resultado da divisão é:');
    console.log(division(function (firstNumber, secondNumber) { return firstNumber / secondNumber; }));

    console.log('O resto da divisão é:');
    console.log(mod(function (firstNumber, secondNumber) { return firstNumber % secondNumber; }));
