(function () {
    ...
    */
    console.log('\nOperation:');
    let operation = justMod2Or3.reduce(function (accumulator, value) {
    ...
    */
    console.log('\nOperation 2:');
    let operation2 = justMod2Or3.reduceRight(function (accumulator, value) {
        return (accumulator + 1) * value;
    }, 0);
    ...
    */
    ...
    let name = ['e', 'du', 'ar', 'do'];
    let nameP = name.reduce(function (accumulator, value) {
    ...
    */
    console.log('\nInversed Name:');
    let inversedName = name.reduceRight(function (accumulator, value) {
    ...
    */
    ...
    //Ele simplismente não achou o number: 2, pois o objeto (referência) que estou tentando procurar é diferente do objeto (referência) que tem dentro do array ou seja, cada objeto tem uma referência única na memória.
