(function () {
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/, 'Eduardo de Araújo Gomes Filho'));
    // ?
    ...
    */
    ...
    let replacePhrase = text.replace(/(O Centauro de Luvas)/g, function (phrase) {
    ...
    */
    ...
    let regexDate = /(\d\d) de (junho|julho) de (\d\d\d\d)/gi;
    ...
    */
    console.log('\nReplace de datas:');
    function replaceDate(allMatchs, day, month, year) {
