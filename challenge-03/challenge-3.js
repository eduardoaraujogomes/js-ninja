...
console.log(pessoa.nomeCompleto());//Eduardo de Araújo
...
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
console.log(pessoa.mostrarPeso()); //Eu peso 94.5 quilos
...
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
console.log(pessoa.mostrarAltura()); //Minha altura é 1.85 metros
...
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
console.log(pessoa.andadno); //true
...
console.log(pessoa.caminhouQuantosMetros); //5013
...
pessoa.apresentacao = function () {
    ...
    return `
    Olá, eu sou ${sexo} ${pessoa.nomeCompleto()}, tenho ${pessoa.idade} ${idadeAnos}, 
